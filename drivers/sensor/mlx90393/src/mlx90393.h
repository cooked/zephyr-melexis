...
#define MLX90393_REG_RES_X					(0x01)
#define MLX90393_REG_RES_X_BITS				(BIT(5) | BIT(6))
...
int write_read_mlx90393(const struct device *dev, const void *write_buf, size_t num_write, void *read_buf, size_t num_read);
...
// Interface
//enum mlx90393_mode mlx90393_get_mode(); //TODO:
int mlx90393_reset(const struct device *dev);
int mlx90393_set_mode(const struct device *dev, uint8_t zyxt,
		enum mlx90393_mode mode, uint32_t rate_ms);
...
int mlx90393_attr_set(const struct device *dev, enum sensor_channel chan, enum sensor_attribute attr, const struct sensor_value *val);
int mlx90393_attr_get(const struct device *dev, enum sensor_channel chan, enum sensor_attribute attr, struct sensor_value *val);
